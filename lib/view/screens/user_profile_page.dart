                                ...
                                InkWell(
                                  onTap: (){
                                    if(index==0){
                                      ...
                                      if(FirebaseAuth.instance.currentUser!.email != "guest@gmail.com")
                                        Navigator.of(context).push(MaterialPageRoute(builder: (context)=>CuratedAppsView(appsList: [], appsIconsList: [], dialog: false, shelfName: "", linkUrl: "", selectedColor: Color(0xffd25250),)));
