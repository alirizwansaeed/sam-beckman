// ignore_for_file: unnecessary_import, unused_import, must_be_immutable, camel_case_types, avoid_unnecessary_containers, non_constant_identifier_names
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    obscureText: true,
                    decoration: InputDecoration(
                        hintText: '${widget.profile!.password.toString()}'),
                  ),
                  SizedBox(
                    height: 10,
                  ),
                        ...
                        onPressed: () async {
                          if (password.text != confirmpassword.text) {
                            Fluttertoast.showToast(
                                msg: 'Password doent\'t match');
                          }
                          if (password.text.characters.length > 6 &&
                                              ...
                                              ElevatedButton(
                                                ...
                                                onPressed: () async {
                                                  ...
                                                  try {
                                                    ...
                                                    Fluttertoast.showToast(
                                                        msg:
                                                            'Please Login again to edit profile');
                                                    return null;
                                                  }
                                                  var Reference =
