...
class _HomeState extends State<Home> with SingleTickerProviderStateMixin {
  ...
  getVideos() async {
    videos = APIService.instance.fetchVideosFromPlaylist(
            ...
            children: [
              ...
              DraggableScrollableSheet(
                ...
                builder: ((context, scrollController) =>
                    VideosPage(controller: scrollController, videos: videos)),
              ),
            ],
          ),
        ),
...
class _HomePageBodyState extends State<HomePageBody>
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: CustomText(
                text: DateTime.now().hour >= 6 && DateTime.now().hour <= 12
                    ? 'Good Morning!'
            ...
            //     if(snapshot.hasData){
            //       var temp = snapshot.data!.docs[0].data();
                        ...
                        itemBuilder: (context, index, animation) {
                          ...
                          return SlideTransition(
                            ...
                            child: ApplicationContainer(
                              favColor: app ? Colors.red : Colors.grey[400],
            ...
            //         child: FutureBuilder(
            //             future: controller.GetappsOfCatagory(),
            //             builder: (context, snap) {
            //               if (snap.hasData) {
            //                 return AnimatedList(
            ...
            //                     shrinkWrap: true,
            //                     initialItemCount:
            //                         controller.catagoryAppList.length,
            //                     itemBuilder:
            ...
            //                               .category,
            //                           backgroundColor: Color(int.parse(
            //                               '0xff${controller.catagoryAppList.elementAt(index).color}')),
            //                           iconName: controller
            //                               .catagoryAppList
            //                               .elementAt(index)
            //                               .iconName,
            //                           appId: controller.catagoryAppList
            //                               .elementAt(index)
            //                               .appId,
            ...
            //                               .developer
            //                               .toString(),
            //                           link: controller.catagoryAppList
            //                               .elementAt(index)
            //                               .link
            //                               .toString(),
            //                         ),
  ...
  getName() async {
    ...
    // var temp1 = await collectionReference1.doc(currentUser!.uid).get();
