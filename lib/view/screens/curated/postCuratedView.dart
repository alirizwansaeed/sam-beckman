...
class PostCuratedView extends StatefulWidget {
  PostCuratedView({Key? key, required this.appsList, required this.docId})
      : super(key: key);
...
class _PostCuratedViewState extends State<PostCuratedView>
  ...
  updateCuratedApps() async {
    ...
    await collection.doc(widget.docId).update(
        {'apps': widget.appsList}).whenComplete(() => Navigator.pop(context));
  }
}
