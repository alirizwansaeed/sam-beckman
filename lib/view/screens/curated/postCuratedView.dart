...
class PostCuratedView extends StatefulWidget {
   PostCuratedView({Key? key, required this.appsList, required this.docId}) : super(key: key);

  var appsList;
  var docId;

  @override
  State<PostCuratedView> createState() => _PostCuratedViewState();
}

class _PostCuratedViewState extends State<PostCuratedView> with SingleTickerProviderStateMixin{
