...
class homeController extends GetxController {
  ...
  GlobalKey<AnimatedListState> categoryKey = GlobalKey<AnimatedListState>();
  Future ft = Future(() {});
  ...
  Future<QuerySnapshot<Object?>?> GetCatagories() async {
    ...
    apps!.docs.forEach((element) {
      ...
      catagoryList.forEach((element1) {
        if (element1.category == element['category']) add = false;
      });
      if (add) {
        ...
        ft = ft.then((value) {
          return Future.delayed(const Duration(milliseconds: 100), () {
            if (category.value ==
              ...
              categoryKey.currentState!.insertItem(i);
              i = i + 1;
            }
          });
        });
